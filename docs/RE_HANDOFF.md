...
- library inventory: **1,119 classified functions**; all **1,119 / 1,119** now have
  mapping sizes totaling **217,165 bytes**; the independent library exact ledger currently accepts **240 functions / 37,373 body bytes**;
...
Library acceptance now has **240 / 240 configured units** and **37,373 body bytes**
