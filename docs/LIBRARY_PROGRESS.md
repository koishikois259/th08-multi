...
- Inventory-mapped library bytes: **216,386 / 216,386**
- Configured library match units: **70 functions / 9,327 body bytes**
- Exact library functions: **70 / 1,113 (6.29%)**
- Exact library body bytes: **9,327 / 216,386 (4.31%)**
