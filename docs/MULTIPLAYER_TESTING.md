# th08-multi v0.34 manual network testing
...
The distributable `th08-multi-v0.34-patch.zip` contains no original game data.
...
use the same v0.34 build and the same Japanese TH08 1.00d game data. The title
