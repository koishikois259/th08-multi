# th08-multi v0.31 manual network testing
...
The distributable `th08-multi-v0.31-patch.zip` contains no original game data.
...
use the same v0.31 build and the same Japanese TH08 1.00d game data.
