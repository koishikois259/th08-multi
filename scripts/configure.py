...
def configure(build_type):
    with (SCRIPTS_DIR.parent / "build.ninja").open("w") as f:
        ...
        # Dependency-first reconstruction probes are compiled on every normal
        # build but are not linked until their owner subsystems and provisional
        # target-address externs have been recovered.  This keeps authored ECL
        # source compiler-checked without inventing runtime stubs.
        re_probe_sources = [
            "EclManager",
            "EclOperandsInt",
            "EclOperandsFloat",
